...
$total = "";
if(isset($_POST["inputMatricula"]) && isset($_POST["inputNDias"]) && isset($_POST["selectMarca"]) && isset($_POST["inputSegmento"]) && isset($_POST["inputExtras"])){
  $total = simular($_POST["inputNDias"],$_POST["inputSegmento"], $_POST["inputExtras"]);
}
else{
$_SESSION["garagem"] = 
array(1 => array("31-HG-24",5,"Audi","Utilitário/Sedan","Ar Condicionado<br>Estofos em Pele<br>PinturaMetalizada", "170€"),
      2 => array("54-FG-78",10,"Mercedes-Benz","SUV/Monovolume","GPS", "365€"));
}
        ...
        <div class="card-body bg-light">
          <form id="formRentACar" action="" method="POST">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-2">
                <input type="text" class="form-control" id="inputRes" name="inputRes" value="<?php echo $total; ?>">
              </div>
              <div class="col-sm-4">
