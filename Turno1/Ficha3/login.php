    ...
    <div class="container">
        <div class="card card-container">
            ...
            <form class="form-signin" method="POST" action="welcome.php">
                ...
                <input type="email" value="<?php echo isset($_COOKIE['email']) ?  $_COOKIE['email'] : ''  ?>" name="inputEmail" id="inputEmail" class="form-control" placeholder="Email address" required autofocus>
